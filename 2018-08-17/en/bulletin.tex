...
\item Das vollständige Couvert bitte bis am \textbf{13.~August~2018} an die aufgedruckte Adresse senden.
\end{enumerate}
\end{textblock}
...
\vspace{0.2cm}
Wenn du bei der Abstimmung 2 auf jeden Fall für eine Stimmfreigabe stimmen möchtest, stimme zwei Mal \enquote{Nein}, wenn du die Parole in jedem Fall publiziert haben möchtest, stimme zwei Mal \enquote{Ja} %https://projects.piratenpartei.ch/projects/statrev/wiki/Parolenfassung hier abgeschrieben
